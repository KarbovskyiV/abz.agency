        ...
        <div class="border p-3">
            ...
            <form action="{{ route('employees.store') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="tel" id="phone_number" name="phone_number" class="form-control" placeholder="+380 (50) 458 15 47"
                           >
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="number" id="salary" name="salary" class="form-control" placeholder="500,000" >
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="text" id="head" name="head" class="form-control"  placeholder="Frederick Banting"
                           >
                    @if ($errors->has('head'))
